...
class GreatExpectationsExecutor:
    ...
    async def _run_validation(
        ...
        if html_report is None and results:
            html_report = self._generate_error_report(results, table_name)
    ...
    def _generate_error_report(
        ...
        for r in results:
            ...
            <tr>
                <td>{r.check_name}</td>
                <td>{status_icon} {r.status.upper()}</td>
                <td>{r.message or '-'}</td>
            </tr>"""
...
<html>
<head>
    <title>Quality Report - {table_name}</title>
    <style>
        ...
        .stat.warning {{ background: #fff8e1; color: #f9a825; }}
...
<body>
    <div class="container">
        ...
        <div class="summary">
            <div class="stat passed"><div class="stat-value">{passed}</div><div class="stat-label">Passed</div></div>
            ...
            <div class="stat warning"><div class="stat-value">{warnings}</div><div class="stat-label">Warnings</div></div>
        </div>
        ...
        <div class="footer">
            <p>Generated by Chalk and Duster - Data Quality Framework</p>
        </div>
    </div>
</body>
</html>"""
